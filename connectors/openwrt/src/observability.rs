//! EP-030 OpenWrt observability (M3).
//!
//! Bounded, poison-safe observability for the OpenWrt connector:
...
/// One audited OpenWrt operation (bounded, redacted).
...
/// Bounded redacted audit ring + counters for the OpenWrt adapter.
///
...
mod tests {
    ...
    fn ep030_unit_observability_redacts_secrets_at_insert() {
        ...
        obs.record(SentinelAuditEntry {
            ...
            outcome: "ok".into(),
            detail: "applied with sekret-pass".into(),
