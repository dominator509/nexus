...
//!
//! The A2A gateway crate may import `nexus-domain`, `nexus-auth`,
...
#[test]
fn ep012_unit_a2a_crate_has_no_infrastructure_dependencies() {
    let output = Command::new("cargo")
        .args(["tree", "-p", "nexus-a2a", "--prefix", "none"])
    ...
    assert!(
        violations.is_empty(),
        "nexus-a2a dependency tree contains forbidden crates: {:?}\n{}",
        violations,
        tree
    );
}
